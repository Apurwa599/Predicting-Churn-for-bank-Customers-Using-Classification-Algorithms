...
### 5️⃣ Custom Test Data Preprocessing Pipeline (`DfPrepPipeline`)
...
### 6️⃣ Test Data Preparation

* Test data is passed through `DfPrepPipeline`
* Infinite and missing values are handled
* Final shape of test data is verified

Purpose: To ensure test data matches training feature space exactly.

---

### 7️⃣ Model Prediction on Test Data
...
> “I built an end-to-end churn prediction system using Random Forest, handled categorical encoding and feature alignment issues, optimized hyperparameters with GridSearchCV, and evaluated performance using ROC–AUC and classification metrics.”
...
**Apurwa Khare**
MCA (AIML) | Data Science & Machine Learning
...
4. Review outputs and plots for evaluation
